...
$$
\text{min} \sum_{i=1}^N \|\| \mathbf y_i - \sum_{\ell=1}^q a_{i\ell} \mathcal L (\mathbf X_{\ell} \mathbf D_{\ell} \mathbf X_{\ell}')  \|\|_2^2 + \phi \sum_{\ell=1}^q
$$

```{=tex}
\begin{equation}
\begin{align}
\text{min} \sum_{i=1}^N \|\| \mathbf y_i - \sum_{\ell=1}^q a_{i\ell} \mathcal L (\mathbf X_{\ell} \mathbf D_{\ell} \mathbf X_{\ell}')  \|\|_2^2
\end{align}
\end{equation}
```
